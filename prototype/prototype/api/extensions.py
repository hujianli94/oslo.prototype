...
class ExtensionManager(object):
    ...
    See prototype/tests/api/extensions/foxinsocks/extension.py for an
...
class ControllerExtension(object):
    """Extend core controllers of prototype OpenStack API.

    Provide a way to extend existing prototype OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in prototype."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None):
        ...
        prototype.policy.enforce(context, action, target)
